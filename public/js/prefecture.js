...
window.onload = function () {
    ...
    drawAvgPrice('bar', "http://www.chika.com/avgs/" + prefectureName.substring(0, 3) + '/', document.getElementById("post_price_trending"));
    //
    ...
    drawPriceChangeRate('http://www.chika.com/avg2/" + prefectureName.substring(0, 3) + '/'', document.getElementById("price_change_rate"));
    //
